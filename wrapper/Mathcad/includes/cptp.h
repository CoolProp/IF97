// if97_cptp stub - Interfaces CoolProp IF97 function to Mathcad
//

// this code executes the user function if97_cptp(P), which is a wrapper for
// the CoolProp-IF97 function, cpmass_Tp(T,P).
LRESULT  if97_CpTP(
...
{  
    ...
    try {
        c->real = IF97::cpmass_Tp(a->real,b->real);
    }
